...
INSERT INTO tasks (project_id, sub_project_id, title, description, start_date, end_date, duration, user_id)
VALUES
    (1, NULL, 'Task 1 for Alpha', 'somedesc', '2024-01-01', '2024-01-15', 14, 1),
    (1, 2, 'Task 2 for Alpha', 'somedesc', '2024-01-01', '2024-01-15', 14, 1),
    (1, NULL, 'Task 3 for Alpha', 'somedesc', '2024-01-01', '2024-01-15', 14, 1);
